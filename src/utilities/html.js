...
function layout(title, content, csrfToken = '') {
  const navigation = csrfToken ? `<header><a class="brand" href="/dashboard"><span class="brand-mark">W</span><span><strong>CHAINCODE</strong><small>WHATSAPP DISTRIBUTION</small></span></a><nav><a href="/dashboard">Inventory</a><a href="/dashboard/codes">Lifecycle</a><a href="/dashboard/groups">Groups</a><a href="/dashboard/admins">Admins</a><a href="/dashboard/audit">Ledger</a><a href="/dashboard/failed">Alerts</a><form method="post" action="/logout" class="inline"><input type="hidden" name="_csrf" value="${escapeHtml(csrfToken)}"><button class="nav-button">Disconnect</button></form></nav></header>` : '';
